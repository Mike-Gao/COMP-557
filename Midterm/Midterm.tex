...
\begin{enumerate}
    ...
    \item We let $\vec{n}$ be our z axis. We then find the near plane's position with b: $\vec{n}=-b.z$
    \item We then project onto the ground plane using the projection matrix P from Q3
    \item $p' = FPF^{-1}p$
\end{enumerate}
